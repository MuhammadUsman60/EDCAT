    ...
    <>
      ...
      <div>
        ...
        <div className='row w-100 p-5'>
          <div className='col animated-2'>
            <h1 className='texth1c'>CONTACT US</h1>
            <div></div>
            <p className='textp1c'>CONNECTING WITH US IS EASY!</p>
            <h1 className='texth1c'>(347) 732-5294</h1>
            <p className='textp1c'>1117 E PLAZA DR. SUITE A</p>
            <p className='textp1c'>EAGLE, ID 83616</p>
            <p className='textp1c' style={{ color: 'brown', fontWeight: '500' }}>INFO@EVOLVESTEEL.COM</p>
          </div>
          <div className='col animated-21'>
            <form onSubmit={handleSubmit}>
              <div className="mb-3 textp1c">
                <label htmlFor="name" className="form-label" style={{ color: 'brown', fontWeight: '500' }}>Name</label>
              ...
              <div className="mb-3 textp1c">
                <label htmlFor="email" className="form-label" style={{ color: 'brown', fontWeight: '500' }}>Email address</label>
              ...
              <div className="mb-3 textp1c">
                <label htmlFor="message" className="form-label" style={{ color: 'brown', fontWeight: '500' }}>Message</label>

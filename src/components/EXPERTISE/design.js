...
export default function Design() { // Changed component name to start with a capital letter
  return (
    <div>
      <div>
        <h1>DESIGN ASSIST/PRE-CONSTRUCTION</h1>
        <p>
          ...
          located here in Boise, ID. Evolve understands that, due to the nature
          of the business, communication and collaboration are extremely
          important. The Design Assist process was designed to deliver a price
          certainty for their customers. The Design Assist process will achieve
          the goal to save money for their customers’ projects.
        </p>
      </div>
      <div>
